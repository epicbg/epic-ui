...
/* harmony import */ var _selector__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./selector */ "./src/js/selector.js");
/* harmony import */ var _watcher__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./watcher */ "./src/js/watcher.js");
...
function () {
  function ui(props) {
    ...
    this.watch = _watcher__WEBPACK_IMPORTED_MODULE_2__["default"]; // Third party libs

    this.request = axios__WEBPACK_IMPORTED_MODULE_3___default.a; // Listeners and renderers

    this.renderHTML();
    this.watchDirectives(); // Call ui constructor
  ...
  _createClass(ui, [{
    ...
    value: function renderHTML() {
      ...
      this.selector.findDirectives('ui-bind').forEach(function (el) {
        return _this.render.uiBindDirective.call(_this, el);
      });
      this.selector.findDirectives('ui-text').forEach(function (el) {
        return _this.render.uiTextDirective.call(_this, el);
      });
      this.selector.findDirectives('ui-for').forEach(function (el) {
        return _this.render.uiForDirective.call(_this, el);
      });
      this.selector.findDirectives('ui-if').forEach(function (el) {
        return _this.render.uiIfDirective.call(_this, el);
      });
      this.selector.findDirectives('ui').forEach(function (el) {
        return _this.render.uiDirective.call(_this, el);
      });
    ...
    value: function watchDirectives() {
      ...
      // Two way binding
      this.selector.findDirectives('ui-bind').forEach(function (el) {
        return _this2.watch.binding.call(_this2, el);
      }); // UI event handler

      this.selector.findDirectives('ui-on').forEach(function (el) {
        return _this2.watch.method.call(_this2, el);
      });
    }
  }]);
...
function () {
  ...
  _createClass(Selector, [{
    ...
    value: function findDirectives(directive) {
      return document.querySelectorAll("[".concat(directive, "]")).filter(function (el) {
