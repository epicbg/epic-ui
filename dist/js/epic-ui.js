...
function () {
  ...
  _createClass(ui, [{
    ...
    value: function render() {
      ...
      document.querySelectorAll('[ui-bind]').forEach(function (el) {
        var attr = el.getAttribute('ui-bind');
        el.value = _this.props.data[attr];
      });
      document.querySelectorAll('[ui-text]').forEach(function (el) {
        var attr = el.getAttribute('ui-text');
        el.innerHTML = _this.props.data[attr];
      });
      document.querySelectorAll('[ui]').forEach(function (el) {
        var ui_data = el.getAttribute('ui').split(':');
        el.setAttribute(ui_data[0], _this.props.data[ui_data[1]]);
      });
    }
  }, {
    key: "watchData",
    value: function watchData() {
      ...
      document.querySelectorAll('[ui-bind]').forEach(function (el) {
        el.addEventListener('input', function (e) {
          return _this2.setDataPropVal(e, _this2);
        });
      });
      document.querySelectorAll('[ui-on]').forEach(function (el) {
    ...
    key: "setDataPropVal",
    value: function setDataPropVal(e, context) {
